...
components.mdi = {
	selector: '[class*="mdi"]',
	styles: '/_includes/components/mdi/mdi.css'
};

components.grid = {
	selector: '.container, .container-fluid, .row, [class*="col-"]',
	styles: '/_includes/components/grid/grid.css'
};

components.block = {
	selector: '.block',
	styles: '/_includes/components/block/block.css'
};

components.blurb = {
	selector: '.blurb',
	styles: [
		'/_includes/components/media/media.css',
		'/_includes/components/blurb/blurb.css'
	]
};

components.box = {
	selector: '.box',
	styles: '/_includes/components/box/box.css'
};

components.button = {
	selector: '.btn, .btn-group',
	styles: '/_includes/components/button/button.css'
};

components.divider = {
	selector: '.divider',
	styles: '/_includes/components/divider/divider.css'
};

components.form = {
	selector: '.form-group, .input-group, .form-check, .custom-control, .form-control',
	styles: '/_includes/components/form/form.css'
};

components.formOutput = {
	selector: '.form-output',
	styles:   '/_includes/components/form-output/form-output.css'
};

components.icon = {
	selector: '.icon',
	styles: '/_includes/components/icon/icon.css'
};

components.imageSvg = {
	selector: '.image-svg',
	styles: '/_includes/components/image-svg/image-svg.css'
};

components.list = {
	selector: '.list',
	styles: '/_includes/components/list/list.css'
};

components.media = {
	selector: '.media',
	styles: '/_includes/components/media/media.css'
};

components.partner = {
	selector: '.partner',
	styles: '/_includes/components/partner/partner.css'
};

components.post = {
	selector: '.post, .post-modern',
	styles: '/_includes/components/post/post.css'
};

components.pricing = {
	selector: '.pricing, .pricing-modern',
	styles: '/_includes/components/pricing/pricing.css'
};
...
components.quote = {
	...
	styles: [
		'/_includes/components/media/media.css',
		'/_includes/components/quote/quote.css'
	]
};

components.rights = {
	selector: '.rights',
	styles: '/_includes/components/rights/rights.css'
};

components.section = {
	selector: 'section',
	styles: '/_includes/components/section/section.css'
};

components.snackbar = {
	selector: '.snackbar',
	styles: '/_includes/components/snackbar/snackbar.css'
};

components.table = {
	selector: '.table',
	styles: '/_includes/components/table/table.css'
};

components.team = {
	selector: '.team, .team-mini',
	styles: '/_includes/components/team/team.css'
};

components.video = {
	selector: '.video',
	styles: '/_includes/components/video/video.css'
};

components.accordion = {
	selector: '.accordion',
	styles: '/_includes/components/accordion/accordion.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/current-device/current-device.min.js',
		'/_includes/components/multiswitch/multiswitch.min.js'
	],
	init: function ( nodes ) {
...
components.animate = {
	...
	styles: '/_includes/components/animate/animate.css',
	script: '/_includes/components/current-device/current-device.min.js',
	init: function ( nodes ) {
...
components.countdown = {
	...
	styles: '/_includes/components/countdown/countdown.css',
	script: [
		'/_includes/components/progress-circle/progress-circle.min.js',
		'/_includes/components/countdown/countdown.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
...
components.counter = {
	...
	styles: '/_includes/components/counter/counter.css',
	script: '/_includes/components/counter/counter.min.js',
	init: function ( nodes ) {
		let observer = new IntersectionObserver( function ( entries, observer ) {
			entries.forEach( function ( entry ) {
				let node = entry.target;
...
// 	script: [
// 		'/_includes/components/jquery/jquery.min.js',
// 		'/_includes/components/blotter/blotter.min.js',
// 		'/_includes/components/blotter/liquidDistortMaterial.js'
// 	],
// 	init: function () {
...
components.fullpage = {
	selector: '.fullpage',
	styles: '/_includes/components/fullpage/fullpage.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/fullpage/fullpage.min.js',
		'/_includes/components/util/util.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			let
...
components.imageHover = {
	...
	styles: '/_includes/components/image-hover/image-hover.css',
	script: [
		'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenMax.min.js',
		'/_includes/components/image-hover/three.min.js',
		'/_includes/components/image-hover/hover.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			let
...
components.lightgallery = {
	...
	styles: '/_includes/components/lightgallery/lightgallery.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/lightgallery/lightgallery.min.js'
	],
	init: function ( nodes ) {
		if ( !window.xMode ) {
			nodes.forEach( function ( node ) {
...
components.modal = {
	selector: '.modal',
	styles: '/_includes/components/modal/modal.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/bootstrap/js/popper.min.js',
		'/_includes/components/bootstrap/js/bootstrap.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			$( node ).modal({
...
components.multiswitch = {
	...
	styles: '/_includes/components/multiswitch/multiswitch.css',
	script: [
		'/_includes/components/current-device/current-device.min.js',
		'/_includes/components/multiswitch/multiswitch.min.js'
	],
...
components.nav = {
	selector: '.nav',
	styles: '/_includes/components/nav/nav.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/bootstrap/js/popper.min.js',
		'/_includes/components/bootstrap/js/bootstrap.min.js'
...
components.owl = {
	...
	styles: '/_includes/components/owl-carousel/owl.carousel.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/owl-carousel/owl.carousel.min.js',
		'/_includes/components/util/util.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
...
components.rdMailform = {
	...
	styles: [
		'/_includes/components/rd-mailform/rd-mailform.css',
		'/_includes/components/font-awesome/font-awesome.css',
		'/_includes/components/mdi/mdi.css'
	],
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/rd-mailform/rd-mailform.min.js',
	],
	init: function ( nodes ) {
		let i, j, k,
...
components.rdNavbar = {
	selector: '.rd-navbar',
	styles: '/_includes/components/rd-navbar/rd-navbar.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/util/util.min.js',
		'/_includes/components/current-device/current-device.min.js',
		'/_includes/components/rd-navbar/rd-navbar.min.js'
	],
...
components.slick = {
	...
	styles: '/_includes/components/slick/slick.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/slick/slick.min.js',
		'/_includes/components/util/util.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
...
components.swiper = {
	...
	styles: [
		'/_includes/components/animate/animate.css',
		'/_includes/components/swiper/swiper.css'
	],
	script: [
		'/_includes/components/swiper/swiper.min.js',
		'/_includes/components/swiper/swiper-progress-circle.min.js',
		'/_includes/components/util/util.min.js'
	],
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
...
components.regula = {
	...
	styles: '/_includes/components/regula/regula.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/regula/regula.min.js'
	],
	init: function ( nodes ) {
		let elements = $( nodes );
...
components.tooltip = {
	...
	styles: '/_includes/components/tooltip/tooltip.css',
	script: [
		'/_includes/components/jquery/jquery.min.js',
		'/_includes/components/bootstrap/js/popper.min.js',
		'/_includes/components/bootstrap/js/bootstrap.min.js'
...
components.preloader = {
	selector: '.preloader',
	styles:   '/_includes/components/preloader/preloader.css'
};

components.toTop = {
	selector: 'html',
	styles: '/_includes/components/to-top/to-top.css',
	script: '/_includes/components/jquery/jquery.min.js',
	init: function () {
		if ( !window.xMode ) {
