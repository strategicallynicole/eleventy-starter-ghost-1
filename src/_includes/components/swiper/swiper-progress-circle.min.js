 ...
 */
function VirtualTimer(t){this.duration=t.duration,this.interval=t.interval||40,this.onTick=t.onTick||null,this.progress=null,this.intervalId=null,this.reset()}VirtualTimer.prototype.start=function(){this.intervalId=setInterval(()=>{this.tick()},this.interval)},VirtualTimer.prototype.stop=function(){clearTimeout(this.intervalId)},VirtualTimer.prototype.reset=function(){this.progress=0,this.onTick instanceof Function&&this.onTick.call(this)},VirtualTimer.prototype.tick=function(){this.progress=this.progress+this.interval,this.progress>=this.duration&&(this.stop(),this.progress=this.duration),this.onTick instanceof Function&&this.onTick.call(this)};